    ...
    <main class="nunito">
        ...
        <section class="text-center py-12 bg-gray-100">
            ...
            <div class="grid grid-cols-3 gap-12 container mx-auto">
                ...
                <article class="one">
                    <div class="screen">
                        <img class="rounded-md" src="../../DA1/assets/img/<?php echo $voucher['voucher_image'] ?>"
                            alt="">
        ...
        <section class="text-left py-12 bg-white">
            ...
            <div class="grid grid-cols-3 gap-10 container mx-auto px-20">
                <div class="col-span-1">
                    <img class="py-10" src="../../DA1/assets/img/z2441349567188_31b9578ae6c5e49629cd4562a937e306.jpg"
                        alt="">
                </div>
                <!-- col1 -->
