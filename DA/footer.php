...
<section class="container mx-auto text-white">
    <div class="grid grid-cols-5">
        <div class="my-4">
            <img src="./content/image/logo-white.png" alt="">
            <div class="flex mt-2">
        ...
        <div class="ml-10 pl-6 my-4">
            ...
            <ul>
                ...
                <li class="py-2"><a class="text-sm hover:underline" href="#">Travel
                        Voucher </a></li>
                <li class="py-2"> <a class="text-sm hover:underline" href="#">Bảo hiểm
                        Du lịch</a></li>
                <li class="py-2"><a class="text-sm hover:underline" href="#">Phiếu góp
                        ý</a>
                </li>
            </ul>
        </div>
        <div class="ml-10 pl-6 my-4">
            ...
            <ul>
                <li class="py-2"><a class="text-sm hover:underline" href="#">Quy định
                        bảo vệ </a>
                </li>
                <li class="py-2"><a class="text-sm hover:underline" href="#">Điều khoản
                        chung </a>
                </li>
                <li class="py-2"><a class="text-sm hover:underline" href="#">Hướng dẫn
                        mua tour online</a></li>
                <li class="py-2"> <a class="text-sm hover:underline" href="#">Quy định
                        thanh toán</a></li>
                <li class="py-2"> <a class="text-sm hover:underline" href="#">Chính sách
                        giao nhận</a></li>
                <li class="py-2"><a class="text-sm hover:underline" href="#">Chính sách
                        hủy phạt</a>
                </li>
