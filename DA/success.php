    ...
    <div class="<?php
        ...
        <div class="<?php if (!empty($id_cart)) {
            ...
            <div id="show" class="relative h-screen overflow-hidden text-center">
                <img class="opacity-50" src="../../DA1/assets/img/z2442570690349_c0c3989dee82c622453e8636ffd3924b.jpg"
                    alt="">
                    ...
                    <div class="ml-28 my-auto">
                        ...
                        <div class="bg-pink-400 py-2 my-3">
                            <span class="block font-bold text-white text-center text-2xl">Mã số đặt tour của Quý Khách
                                là: </span>
                            <span
                                class="block font-bold text-white text-center text-4xl pt-2"><?php echo $totall['id_cart'] ?></span>
                        </div>
                        <div>
                    ...
                    <aside class="col-span-2">
                        <form method="POST" class="border p-5 overflow-hidden bg-fixed">
                            ...
                            <div class="mt-5">
                                ...
                                <input disabled
                                    class="my-1 bg-gray-100 bg-opacity-50 px-2 py-1 border focus:outline-none block w-full"
                                    type="text" placeholder="Email" value="<?php echo $showuser['email'] ?>" id="email"
                                    name="email">
                            </div>
                            <!-- end mail -->
                            <div class="mt-5">
                                ...
                                <input disabled
                                    ...
                                    value="<?php echo $showuser['phone_number'] ?>" id="phone" name="phone">
                            </div>
                            <div class="mt-5">
                                <span class="">Địa chỉ</span>
                                <input disabled
                                    class="my-1 bg-gray-100 bg-opacity-50 px-2 py-1 border focus:outline-none block w-full"
                                    type="text" placeholder="Địa chỉ" value="<?php echo $showuser['address'] ?>"
                        ...
                        where cart.username like '$user'";
                            ...
                            <tr class="border">
                                ...
                                <td class=" flex justify-between py-2">
                                    <img width="100" src="../../DA1/assets/img/<?php echo $row['image_main'] ?>" alt="">
                                ...
                                <td class="border"><button
                                        onclick="return confirm('Bạn chắc chắn muốn hủy tour này? Lưu ý bạn sẽ mất số tiền đã cọc trước!!!')"
                                        class="flex mx-auto items-center focus:outline-none text-xl"><a
                                            href="../../DA1/examples/delete/delete.php?id_cartfont=<?php echo $row['id_cart']  ?>"><i
                                                class="far fa-trash-alt hover:text-red-500 text-gray-400"></i></a></button>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
